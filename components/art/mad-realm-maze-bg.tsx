  ...
  return (
    ...
    >
      <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
        <defs>
          <pattern id="mad-realm-maze" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
            {/* Outer maze ring */}
            <rect
              x="4"
              y="4"
            ...
            <rect
              ...
              height="28"
              rx="1"
              stroke="rgb(212,160,23)"
              strokeWidth="0.4"
              fill="none"
              opacity="0.03"
            />
            {/* Maze openings — horizontal */}
            <line x1="4" y1="60" x2="18" y2="60" stroke="rgb(124,58,237)" strokeWidth="0.5" opacity="0.035" />
            <line x1="102" y1="60" x2="116" y2="60" stroke="rgb(124,58,237)" strokeWidth="0.5" opacity="0.035" />
            {/* Maze openings — vertical */}
            <line x1="60" y1="4" x2="60" y2="18" stroke="rgb(192,38,211)" strokeWidth="0.5" opacity="0.03" />
            <line x1="60" y1="102" x2="60" y2="116" stroke="rgb(192,38,211)" strokeWidth="0.5" opacity="0.03" />
            ...
            />
            {/* Diagonal path hints */}
            <line x1="18" y1="32" x2="32" y2="18" stroke="rgb(124,58,237)" strokeWidth="0.3" opacity="0.02" />
            <line x1="88" y1="102" x2="102" y2="88" stroke="rgb(124,58,237)" strokeWidth="0.3" opacity="0.02" />
          </pattern>
        </defs>
