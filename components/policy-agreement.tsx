    ...
    <div className="space-y-6">
      <div className="nec-reg-subcard p-6">
        ...
        >
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">NON-DISCRIMINATION POLICY</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">ANTI-HARASSMENT POLICY</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">Reporting</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">Retaliation</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">Disciplinary or Corrective Action</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">Confidentiality</h4>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">SAFETY CARD FOR A.A. GROUPS</h4>
          ...
          <h5 className="mt-3 font-semibold text-[var(--nec-text)]">Suggested Statement on Safety</h5>
          <p>
          ...
          <h4 className="mt-4 font-semibold text-[var(--nec-text)]">Our Common Welfare</h4>
          <p className="italic">
      ...
      <div className="space-y-4">
        <p className="font-semibold text-[var(--nec-text)]">
        ...
        <p className="text-sm text-[var(--nec-muted)]">
          ...
          <span className="sr-only">Asterisk indicates</span> Required field
        </p>
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="readPolicy" className="font-normal leading-relaxed text-[var(--nec-text)]">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="understandQuestions" className="font-normal leading-relaxed text-[var(--nec-text)]">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="acknowledgeBehavior" className="font-normal leading-relaxed text-[var(--nec-text)]">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="understandAdmission" className="font-normal leading-relaxed text-[var(--nec-text)]">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="understandReporting" className="font-normal leading-relaxed text-[var(--nec-text)]">
              I understand that I have the right to report any behavior deemed unsafe or discriminatory to NECYPAA
              Advisory and/or NECYPAA Host.{" "}
              <span className="text-[var(--nec-pink)]" aria-hidden="true">
                *
              </span>
              <span className="sr-only">(required)</span>
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="understandInvestigation" className="font-normal leading-relaxed text-[var(--nec-text)]">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              aria-required="true"
            />
            <Label htmlFor="signatureAgreement" className="font-normal leading-relaxed text-[var(--nec-text)]">
      ...
      <div className="flex gap-4">
        ...
        <Button onClick={() => onComplete(agreements)} disabled={!allAgreed} className="flex-1">
          {continueLabel}
        </Button>
      </div>
    </div>
