...
export function HexCluster({
  ...
  return (
    ...
    >
      {/* Back hex – orange */}
      <polygon
        points="80,10 105,24 105,52 80,66 55,52 55,24"
        fill="#f97316"
        opacity="0.6"
      />
      {/* Mid hex – pink */}
      <polygon
        points="55,30 80,44 80,72 55,86 30,72 30,44"
        fill="#e8006e"
        opacity="0.7"
      />
      {/* Front hex – cyan */}
      <polygon
        points="40,50 65,64 65,92 40,106 15,92 15,64"
        fill="#00d4e8"
        opacity="0.8"
      />
      {/* Highlight edge on front hex */}
      <polygon
        points="40,50 65,64 65,72 40,58"
        fill="white"
        opacity="0.15"
      />
    </svg>
...
export function Hex({
  ...
  return (
    ...
    >
      ...
      />
      <polygon
        points="43.5,0 87,25 87,40 43.5,15"
        fill="white"
        opacity="0.12"
      />
    </svg>
...
/** Decorative cluster combining multiple elements – for hero or section accents */
export function ArtAccentCluster({
  className = "",
  mirror = false,
}: {
  className?: string
    ...
    >
      <div className="relative w-[200px] h-[200px]">
        ...
        <div className="absolute top-[60px] left-[120px]">
          <Splatter color="#e8006e" size={50} opacity={0.35} />
        </div>
        <div className="absolute top-[20px] left-[160px]">
          <Sparkle color="#fbbf24" size={16} />
        </div>
        <div className="absolute top-[100px] left-[20px]">
          <Drip color="#00d4e8" height={45} opacity={0.4} />
        </div>
        <div className="absolute top-[110px] left-[50px]">
          <Drip color="#e8006e" height={35} opacity={0.3} />
        </div>
        <div className="absolute top-[90px] left-[140px]">
          <Hex color="#f97316" size={30} opacity={0.4} />
        </div>
        <div className="absolute top-[5px] left-0">
          <Sparkle color="#00d4e8" size={12} opacity={0.5} />
        </div>
      </div>
    </div>
  )
