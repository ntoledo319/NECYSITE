...
export default function ShareMenu({
  ...
  return (
    <>
      ...
      >
        <div
          className="nec-share-sheet rounded-t-[1.75rem] border border-[rgba(var(--nec-purple-rgb),0.12)] bg-[rgba(var(--nec-card-rgb),0.98)] p-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] shadow-[0_-8px_40px_rgba(20,14,10,0.12),0_8px_30px_rgba(20,14,10,0.08)] md:rounded-[1.75rem] md:pb-5"
          style={{
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => setOpen(false)}
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[rgba(var(--nec-purple-rgb),0.12)] bg-[rgba(var(--nec-card-rgb),0.9)] text-[var(--nec-muted)] transition-[border-color,background,color] duration-200 hover:border-[rgba(var(--nec-purple-rgb),0.18)] hover:bg-[rgba(var(--nec-purple-rgb),0.04)] hover:text-[var(--nec-text)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--nec-purple)]"
          ...
          <div className="mb-4 grid grid-cols-4 gap-3 sm:grid-cols-5" role="group" aria-label="Sharing platforms">
      ...
      >
        {toast && (
          <div
            className="flex items-center gap-2 rounded-full border border-[rgba(var(--nec-purple-rgb),0.16)] bg-[rgba(var(--nec-card-rgb),0.98)] px-4 py-2.5 text-sm font-medium text-[var(--nec-text)] shadow-[0_18px_40px_rgba(44,24,16,0.12)]"
            style={{
              background: "rgba(var(--nec-card-rgb),0.98)",
            }}
          >
