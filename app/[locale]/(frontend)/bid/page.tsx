...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to start a bid to host a future NECYPAA convention. Requirements, timeline, process, and resources.",
}
    ...
    <InventoryShell
      ...
      pageContent={
        <div className="mb-8 space-y-4 leading-relaxed text-[var(--nec-muted)]">
          <p>Hosting a NECYPAA convention is a profound act of service that unifies your local fellowship.</p>
          <p>
            <strong className="text-[var(--nec-text)]">Status:</strong> The official bidding requirements and packets
            for NECYPAA XXXVII are being finalized by the Advisory Council.
          </p>
          <p>
            If you&apos;re interested in forming a bid committee,{" "}
