...
function CardParticle({ size = 18, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size * 1.3} viewBox="0 0 70 100" fill="none" className={className}>
      ...
      <text x="15" y="30" fontSize="18" fill="currentColor" fontFamily="serif">
        A
      </text>
      <text x="35" y="65" fontSize="22" fill="currentColor" fontFamily="serif" opacity="0.6">
        ♠
      </text>
    </svg>
  )
...
function HourglassParticle({ size = 20, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size * 1.2} viewBox="0 0 60 80" fill="none" className={className}>
      ...
      <path
        d="M15 9 L15 25 C15 35 30 40 30 40 C30 40 45 35 45 25 L45 9"
        stroke="currentColor"
        strokeWidth="2.5"
        fill="none"
      />
      <path
        d="M15 71 L15 55 C15 45 30 40 30 40 C30 40 45 45 45 55 L45 71"
        stroke="currentColor"
        strokeWidth="2.5"
        fill="none"
      />
...
export default function MadRealmParticles() {
  return (
    <div className="mad-realm-particles pointer-events-none fixed inset-0 z-[1] overflow-hidden" aria-hidden="true">
